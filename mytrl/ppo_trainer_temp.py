...
class PPOTrainer(BaseTrainer):
        ...
        for _ in range(self.config.ppo_epochs):
            ...
            for backward_batch_start in range(0, bs, self.config.backward_batch_size):
                ...
                for mini_batch_start in range(0, self.config.backward_batch_size, self.config.mini_batch_size):
                    ...
                    # mini_batch_inds = torch.tensor(mini_batch_inds, dtype=torch.long, device=self.current_device)
    ...
    def train_minibatch(
        ...
        loss = loss_p # + loss_v  # GRPO: remove loss_v
    ...
    def compute_rewards(
        ...
        for score, logprob, ref_logprob, mask in zip(scores, logprobs, ref_logprobs, masks):
            ...
            reward[last_non_masked_index] = score   # GRPO: Remove KL
    ...
    def loss(
        ...
        loss = pg_loss  # + self.config.vf_coef * vf_loss  # GRPO: remove loss_v
